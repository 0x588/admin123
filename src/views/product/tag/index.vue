...
import {deleteTag, getTagPage} from "@/api/product/tag";
import {columns, searchFormSchema} from "@/views/product/tag/tag";
import TagModal from "@/views/product/tag/TagModal.vue";

defineOptions({ name: 'ProductTag' })
...
<template>
  <div class="flex">
    ...
    <TagModal width="80%"  @register="registerModal" @success="handleSuc()" />
  </div>
</template>
